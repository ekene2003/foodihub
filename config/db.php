...
$user = 'root';
$pass = '';
$database = 'foodihub_database';
$db = new mysqli( $hostName, $user, $pass, $database );
if ( $db->connect_error ) echo 'could not connect a database';
...
$create_order_statuses_table = "CREATE TABLE IF NOT EXISTS order_statuses (
          order_status_id INT(255) UNSIGNED PRIMARY KEY  AUTO_INCREMENT,
          name VARCHAR(20) NOT NULL
     ) CHARSET=utf8mb4 COLLATE utf8mb4_unicode_ci, ENGINE = InnoDB";
$db->query( $create_order_statuses_table );
